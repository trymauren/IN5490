...
public class CrawlerAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        // Get and log the current position of the GameObject (agent)
        // stringLogSideChannel.SendString("Moved to: " + transform.localPosition.ToString());
        Vector3 position = transform.position;
        Debug.Log("Agent Position: " + position);
